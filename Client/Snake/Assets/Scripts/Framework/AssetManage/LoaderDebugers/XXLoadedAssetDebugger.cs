...
namespace Framework
{
    ...
    /// </summary>
    public class XXLoadedAssetDebugger : MonoBehaviour
    {
        public string MemorySize;
        public UnityEngine.Object TheObject;
        private const string bigType = "XXLoadedAssetDebugger";
        public string Type;
        private bool IsRemoveFromParent = false;

        public static XXLoadedAssetDebugger Create(string type, string url, UnityEngine.Object theObject)
        {
            ...
            var newHelp = newHelpGameObject.AddComponent<XXLoadedAssetDebugger>();
            newHelp.Type = type;
